...
The `main` branch contains **v0.2.1**, including long-idle recovery, Freshservice Login recovery, F5 recovery, and per-tab recovery when using browser or third-party **Reload All Tabs** actions.
